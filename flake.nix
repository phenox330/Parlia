{
  description = "Parlia - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          parlia = pkgs.rustPlatform.buildRustPackage {
            pname = "parlia";
            inherit version;
            src = self;
          ...
          default = self.packages.${system}.parlia;
        }
      );
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Parlia development environment"
              bun install
